...
class StrategieEnumAdaptateurGr2E10Test {
    ...
    void testAdapter_withValidStrategyType() {
        assertEquals(TypeStrategie.DONNANTDONNANT, StrategieEnumAdaptateurGr2E10.adapter(StrategyType.DONNANT_DONNANT),
                "La correspondance pour StrategyType.DONNANT_DONNANT doit être TypeStrategie.DONNANTDONNANT");

        assertEquals(TypeStrategie.RANCUNIERSTRATEGIE, StrategieEnumAdaptateurGr2E10.adapter(StrategyType.RANCUNIER),
                "La correspondance pour StrategyType.RANCUNIER doit être TypeStrategie.RANCUNIERSTRATEGIE");

        assertEquals(TypeStrategie.PAVLOVSTRATEGIE, StrategieEnumAdaptateurGr2E10.adapter(StrategyType.PAVLOV),
    ...
    void testAdapterInverse_withValidTypeStrategie() {
        assertEquals(StrategyType.DONNANT_DONNANT, StrategieEnumAdaptateurGr2E10.adapterInverse(TypeStrategie.DONNANTDONNANT),
                "La correspondance inverse pour TypeStrategie.DONNANTDONNANT doit être StrategyType.DONNANT_DONNANT");

        assertEquals(StrategyType.RANCUNIER, StrategieEnumAdaptateurGr2E10.adapterInverse(TypeStrategie.RANCUNIERSTRATEGIE),
                "La correspondance inverse pour TypeStrategie.RANCUNIERSTRATEGIE doit être StrategyType.RANCUNIER");

        assertEquals(StrategyType.PAVLOV, StrategieEnumAdaptateurGr2E10.adapterInverse(TypeStrategie.PAVLOVSTRATEGIE),
    ...
    void testAdapter_withAllMappings() {
        for (StrategyType strategyType : StrategyType.values()) {
            TypeStrategie typeStrategie = StrategieEnumAdaptateurGr2E10.adapter(strategyType);
    ...
    void testAdapterInverse_withAllMappings() {
        for (TypeStrategie typeStrategie : TypeStrategie.values()) {
