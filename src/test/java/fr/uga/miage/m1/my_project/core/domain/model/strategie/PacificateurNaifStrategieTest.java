...
class PacificateurNaifStrategieTest {
    ...
    void testCooperateEvenWhenOpponentBetrays() {
        ...
        assertEquals(TYPE_ACTION.COOPERER, result, "La stratégie doit coopérer même si l'adversaire a trahi.");
    }
    ...
    void testBetrayWithHigherProbability() {
        ...
        assertEquals(TYPE_ACTION.TRAHIR, result, "La stratégie doit trahir si la probabilité de coopérer est inférieure à 0.2.");
    }
